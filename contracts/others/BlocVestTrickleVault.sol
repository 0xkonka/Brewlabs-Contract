...
contract BlocVestTrickleVault is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    constructor(address _nft, address _uniRouter, address[] memory _path) {
        bvstNft = _nft;
    ...
    function setHarvestFees(uint8 _feeType, uint256 _inBNBToTreasury, uint256 _inTokenToTreasury, uint256 _toContract)
        external
        onlyOwner
    {
